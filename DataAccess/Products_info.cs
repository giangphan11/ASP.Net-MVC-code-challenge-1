...
namespace DataAccess
{
    public class Products_info
    {
        ...
        public static bool Add(int id_item, string pname, string pmota, string pchitiet, string ppricecurrent,
                               ...
                               int pactive, int pcount)
        {
            try
            {
                object rs = DataProvider.Instance.ExecuteNonQuery("Products_add", id_item, pname, pmota, pchitiet, ppricecurrent, ppriceold, pimage, pnew, pkhuyenmai, phot, pngaydang, pactive, pcount);
        ...
        public static bool Update(int id, int id_item, string pname, string pmota, string pchitiet,
                                  ...
                                  int phot, string pngaydang, int pactive, int pcount)
        {
            try
            {

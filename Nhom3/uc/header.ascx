...
<div id="wp-pos-top">
    <div class=" wp-modulecontainer">
        <div class="wp-modulecontainer_inner">
            <div class="wp-modulecontent" style="height: 70px;">
                <ul class="menu-topmenu menu-iconmenu">
                    <%if (Session["admin"] == null)
                        { %>
                    <li class="item53 order1 first"><a href="default.aspx?page=login" rel="nofollow"><span>Đăng nhập</span></a></li>
                    <li class="item54 order2 last"><a href="Default.aspx?page=register" rel="nofollow"><span>Đăng kí thành viên</span></a></li>
                    <%}
                        else
                        {
                    ...
                    <li class="item53 order1 first"><a href="default.aspx?page=logout" rel="nofollow"><span>Đăng Xuất</span></a></li>
                    <%} %>
                </ul>
    ...
    <div class=" wp-modulecontainer">
        <div class="wp-modulecontainer_inner">
            <div class="wp-modulecontent">
                <p style="text-align: right; height: 70px">
                </p>
                <!--BEGIN Search Box -->

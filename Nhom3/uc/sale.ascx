            ...
            <div class="product-listing-container" style="padding: 0 1.2em 0 0.5em;" id="product_list">
                ...
                <div id="product_list_inner">
                    ...
                    <div class="moduletable">
                        <div class="cat-desc"><font size="6" color="red"><b>Sản Phẩm giảm giá</b></font></div>
                            ...
                            <ItemTemplate>
                                ...
                                <td width="8%" align="center">
                                    ...
                                    <div class="product-price">
                                        <span style="text-decoration: line-through" class="productPrice">
                                            <asp:Label ID="Label3" runat="server" Text='<%# Eval("ppriceold","{0:0,000}")%>'></asp:Label>
                                            VND</span><br />

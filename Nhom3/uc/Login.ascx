            ...
            <div class="com-content ">
                <div class="article">
                    <div class="wp-article-content">
                        <div class="probyitem">
                            <table align="center" cellpadding="0" cellspacing="0" style="border: 1px solid #ccc; height: 191px; width: 300px;">
                                <tr>
                                    <td align="center" colspan="2" class="style1" style="background-image: url('img/icon/loading_bg.png'); background-repeat: no-repeat">
                    ...
                    <div id="jc">
                        <div id="comments" class="style4">
                            <a href="Default.aspx?page=quenmatkhau">Quên mật khẩu </a>&nbsp;|| <a href="Default.aspx?page=register">&nbsp;Đăng Ký</a>
                        </div>
                    </div>
                </div>
            </div>

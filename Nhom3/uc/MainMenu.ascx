...
<div id="wp-menu" class="clearafter">
    <div id="wp-pos-mainmenu">
        <div class=" wp-modulecontainer">
            <div class="wp-modulecontainer_inner">
                <div class="wp-modulecontent">
                    <ul id="menu-menu" class="menu-mainmenu">
                        <li id="menu-item-46" class="menu-item menu-item-type-custom menu-item-object-custom current-menu-item current_page_item menu-item-home menu-item-46"><a title="TRANG CHỦ" href="default.aspx"><span>TRANG CHỦ</span></a></li>

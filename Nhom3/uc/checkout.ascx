...
<div id="wp-centercol_inner">
    <div id="wp-pos-breadcrumbs">
        <span class="breadcrumbs pathway clearafter">
            ...
            <div id="crumbs"><span class="current">Đặt Hàng</span></div>
        </span>
                ...
                <div class="article">
                            ...
                            <table border="0" cellpadding="5" cellspacing="1" width="730" style="border-right: #dddddd 1px solid; border-top: #dddddd 1px solid; font-size: 12px; border-left: #dddddd 1px solid; width: 100%; border-bottom: #dddddd 1px solid; font-family: tahoma; background-color: #dddddd; cellspacing: 0 cellPadding=0 align=center">
                                <tr>
                                    <td align="center" class="giohang"
                                        style="background-color: #ffffff; font-weight: 700;">Mã SP</td>
                                    <td align="center" class="giohang"
                                        style="background-color: #ffffff; font-weight: 700;">Tên SP</td>
                                    <td align="center" class="style2"
                                        style="background-color: #ffffff; font-weight: 700;">Số lượng</td>
                                    <td align="center"
                                        width="90" class="giohang"
                                        style="background-color: #ffffff; font-weight: 700;">Đơn giá</td>
                                    <td align="center"
                                        width="90" class="giohang"
                                        style="background-color: #ffffff; font-weight: 700;">Thành tiền</td>
                                </tr>
                    ...
                    "amount")%>'
                                ...
                                <tr>
                                    ...
                                    <td style="background-color: #ffffff;"></td>
                                    <td style="background-color: #ffffff;" class="style2"></td>
                                    <td class="giohang" style="background-color: #ffffff; font-weight: 700;">Tổng tiền
                                    </td>
                                    ...
                                    <td style="height: 21px">
                                        <table border="0" cellpadding="0" cellspacing="3">
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:TextBox ID="txtnguoidh" runat="server" Width="220px" CssClass="inputbox"></asp:TextBox>
                                            ...
                                            <tr>
                                                <td style="height: 10px; width: 139px;"></td>
                                                <td style="height: 10px"></td>
                                            </tr>
                                            <tr>
                                                <td style="height: 24px; width: 139px;"></td>

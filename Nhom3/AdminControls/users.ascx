        ...
        <div class="card">
            ...
            <div class="card-content">
                <table border="0" cellpadding="2" cellspacing="2" width="600">
                    ...
                    <tr>
                        <td style="width: 125px">Tên đăng nhập
                        </td>
                        <td style="width: 5px"></td>
                        <td>
                    ...
                    <tr>
                        <td style="width: 125px; height: 28px;">Địa chỉ :
                        </td>
                    ...
                    <tr>
                        <td style="width: 125px">Ngày sinh
                        </td>
                        <td style="width: 5px"></td>
                        <td>
                    ...
                    <tr>
                        <td style="width: 125px">Số điện thoại
                        </td>
                        <td style="width: 5px"></td>
                        <td>
                    ...
                    <tr>
                        <td style="width: 125px; height: 120px">Quyền hạn
                        </td>
                    ...
                    <tr>
                        <td style="width: 125px">Trạng thái:
                        </td>
                        <td style="width: 5px"></td>
                        <td>
                    ...
                    <tr>
                        <td style="width: 125px; height: 29px;"></td>
        ...
        <div class="card">
            ...
            <div class="card-content">
                ...
                <table border="0" cellpadding="2" cellspacing="2" width="600">
                    ...
                    <tr>
                        <td style="width: 125px; height: 19px;"></td>
                    ...
                    <tr>
                        ...
                        <td style="width: 5px"></td>
                        <td>
                            <asp:TextBox ID="n_username" runat="server" Width="100%" CssClass="form_input"></asp:TextBox>
                    ...
                    <tr>
                        ...
                        <td style="width: 5px"></td>
                        <td>
                            <asp:TextBox ID="n_email" runat="server" Width="100%" CssClass="form_input"></asp:TextBox>
                    ...
                    <tr>
                        <td style="width: 125px; height: 16px;">Mật khẩu:
                        </td>
                        <td style="width: 5px; height: 16px;"></td>
                        <td style="height: 16px">
                            <asp:TextBox ID="n_pass1" runat="server" TextMode="Password" Width="100%" CssClass="form_input"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server"
                                ControlToValidate="n_pass1" ErrorMessage="(*)"></asp:RequiredFieldValidator>
                        </td>
                    </tr>
                    <tr>
                        <td style="width: 125px">Nhập lại mật khẩu:
                        </td>
                        <td style="width: 5px"></td>
                        <td>
                            <asp:TextBox ID="n_pass2" runat="server" TextMode="Password" Width="100%" CssClass="form_input"></asp:TextBox>
                    ...
                    <tr>
                        ...
                        <td style="width: 5px"></td>
                        <td>
                            <asp:TextBox ID="fuulname" runat="server" Width="100%" CssClass="form_input"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator11" runat="server"
                                ControlToValidate="fuulname" ErrorMessage="(*)"></asp:RequiredFieldValidator>
                        </td>
                    </tr>
                    <tr>
                        <td style="width: 125px">Địa chỉ
                        </td>
                        <td style="width: 5px"></td>
                        <td>
                            <asp:TextBox ID="n_add" runat="server" Width="100%" CssClass="form_input"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator12" runat="server"
                                ControlToValidate="n_add" ErrorMessage="(*)"></asp:RequiredFieldValidator>
                        </td>
                    </tr>
                    <tr>
                        <td style="width: 125px; height: 28px;">Ngày sinh :
                        </td>
                        <td style="width: 5px; height: 28px;"></td>
                        <td style="height: 28px">
                    ...
                    <tr>
                        ...
                        <td style="width: 5px"></td>
                        <td>
                            <asp:TextBox ID="n_phone" runat="server" Width="100%" CssClass="form_input"></asp:TextBox>
                    ...
                    <tr>
                        <td style="width: 125px">Kích hoạt:
                        </td>
                        <td style="width: 5px"></td>
                        <td>

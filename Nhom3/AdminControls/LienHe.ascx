...
<asp:MultiView ID="MultiView1" runat="server">
        ...
        <div class="card">
            ...
            <div class="card-content">
                <table style="width: 650px;">
                    <tr>
                        <td style="font-weight: 700">Xem Tin Nhắn
    ...
    <asp:View ID="View2" runat="server">
        <table border="0" cellpadding="0" cellspacing="0" width="600">
            ...
            <tr>
                <td style="width: 125px; height: 102px">Thông tin&nbsp; :</td>
            ...
            <tr>
                <td style="width: 125px">Trạng thái</td>
                <td style="width: 5px"></td>
                <td style="width: 479px">
    ...
    <asp:View ID="View3" runat="server">
        <table id="Table4" border="0" cellpadding="0" style="border-collapse: collapse" width="100%">
            ...
            <tr>
                <td style="width: 73px; height: 19px;" class="style1">&nbsp;</td>
                <td width="15" style="height: 19px" class="style1">&nbsp;</td>

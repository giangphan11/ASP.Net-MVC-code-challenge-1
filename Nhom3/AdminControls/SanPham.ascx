    ...
    <div class="card-content">
        <table border="0" cellpadding="0" cellspacing="0"
            ...
            <tr>
                ...
                <td colspan="1"></td>
                <td colspan="2"></td>
                <td align="center" colspan="1" rowspan="3"></td>
            </tr>
            <tr>
                ...
                <td style="padding-left: 10px">
                    <asp:ImageButton ID="btnTimKiem" runat="server" CausesValidation="False"
                        ImageUrl="~/uploads/search-bt.png" OnClick="btnTimKiem_Click" /></td>
            </tr>
            <tr>
        ...
        <asp:MultiView ID="MultiView1" runat="server">
            ...
            <asp:View ID="View2" runat="server">
                <table id="table2" border="0" cellpadding="0" style="border-collapse: collapse" width="100%" cellspacing="0">
                    <tr>
                        <td colspan="3">&nbsp; <strong>THÊM SẢN PHẨM</strong></td>
                    </tr>
                    <tr style="color: #000000">
                        <td style="height: 19px; width: 102px;"></td>
                        <td style="height: 19px"></td>
                        <td style="height: 19px">
                            <asp:Label ID="Label1" runat="server" ForeColor="Red"></asp:Label></td>
                    </tr>
                    <tr style="color: #000000">
                        <td style="width: 102px; height: 24px">Danh mục</td>
                    ...
                    <tr>
                        <td style="width: 102px">Tên SP&nbsp;</td>
                        <td>&nbsp;</td>
                        <td>
                    ...
                    <tr>
                        <td style="width: 102px">Mô tả SP</td>
                        <td></td>
                    ...
                    <tr style="font-size: 12pt; font-family: Times New Roman">
                        <td style="width: 102px; height: 24px;">Giá hiện tại</td>
                        <td style="height: 24px">&nbsp;</td>
                        <td style="height: 24px">
                    ...
                    <tr style="font-size: 12pt; font-family: Times New Roman">
                        <td style="width: 102px; height: 24px">Già Củ</td>
                        <td style="height: 24px"></td>
                        <td style="height: 24px">
                    ...
                    <tr style="font-size: 12pt; font-family: Times New Roman">
                        <td style="width: 102px; height: 24px">Số lượng</td>
                        <td style="height: 24px"></td>
                        <td style="height: 24px">
                            <asp:TextBox ID="txtcount" runat="server" CssClass="txt_10" Width="200px"></asp:TextBox>
                        </td>
                    </tr>
                    <tr style="font-size: 12pt; font-family: Times New Roman">
                        <td style="height: 24px; width: 102px;">Hình ảnh 
                        </td>
                        <td style="height: 24px"></td>
                        <td style="height: 24px">
                    ...
                    <tr style="font-size: 12pt; font-family: Times New Roman">
                        <td style="height: 22px; width: 102px;">Tùy chọn 
                        </td>
                        ...
                        <td style="height: 22px">
                            <table border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                    ...
                                    <td style="width: 150px">Sản phẩm mới</td>
                                </tr>
                                <tr>
                                    <td>
                                        <asp:CheckBox ID="chkissaleoff" runat="server" /></td>
                                    <td style="width: 100px">&nbsp;Sản phẩm khuyến mại</td>
                                </tr>
                                <tr>
                                    <td style="height: 20px">
                                        <asp:CheckBox ID="chkbestsell" runat="server" Checked="True" /></td>
                                    <td style="width: 100px; height: 20px;">&nbsp;Sản phẩm Vip</td>
                                </tr>
                            </table>
                        </td>
                    </tr>
                    <tr style="font-size: 12pt; font-family: Times New Roman">
                        <td style="height: 24px; width: 102px;">Hiển thị sp</td>
                        <td style="height: 24px">&nbsp;</td>
                        <td style="height: 24px">
            ...
            <asp:View ID="View3" runat="server">
                <table id="Table3" border="0" cellpadding="1" style="border-collapse: collapse" width="100%">
                    <tr>
                        ...
                        <td>&nbsp;</td>
                        <td>SỬA SẢN PHẨM<asp:HiddenField ID="HiddenField1" runat="server" />
                    ...
                    <tr style="color: #000000; font-size: 12pt; font-family: Times New Roman;">
                        <td style="width: 105px">Danh mục con</td>
                        <td></td>
                        <td>
                    ...
                    <tr style="font-size: 12pt; font-family: Times New Roman">
                        <td style="height: 24px; width: 105px;">Hình ảnh
                        </td>
                        <td style="height: 24px"></td>
                        <td valign="bottom">
                    ...
                    <tr style="font-size: 12pt; font-family: Times New Roman">
                        <td style="width: 105px">Mã sản phẩm 
                        </td>
                    ...
                    <tr style="font-size: 12pt; font-family: Times New Roman">
                        <td style="height: 69px; width: 105px;">Mô tả
                        </td>
                    ...
                    <tr style="font-size: 12pt; font-family: Times New Roman">
                        ...
                        <td style="height: 246px; font-weight: bold;">&nbsp;</td>
                        <td style="height: 246px">
                            <FTB:FreeTextBox ID="e_chitiet" runat="server"></FTB:FreeTextBox>
                        </td>
                    </tr>
                    <tr style="font-size: 12pt; font-family: Times New Roman">
                        <td style="width: 105px" valign="top">Giá
                        </td>
                        <td>&nbsp;</td>
                        <td>
                    ...
                    <tr style="font-size: 12pt; font-family: Times New Roman">
                        <td style="width: 105px">Số lượng
                        </td>
                        <td>&nbsp;</td>
                        <td>
                            <asp:TextBox ID="e_count" runat="server" Width="80px"></asp:TextBox></td>
                    </tr>
                    <tr style="font-size: 12pt; font-family: Times New Roman">
                        <td style="height: 22px; width: 105px;" valign="top">Tùy chọn SP:</td>
                        <td style="height: 22px">&nbsp;</td>
                        <td style="height: 22px">
                            <table border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>Cập nhật&nbsp; ngày đăng</td>
                                </tr>
                            </table>
                        </td>
                    </tr>
                    <tr style="font-size: 12pt; font-family: Times New Roman">
                        <td style="height: 24px; width: 105px;">Hiển thị 
                        </td>
                        <td style="height: 24px">&nbsp;</td>
                        <td style="height: 24px">
                    ...
                    <tr style="font-size: 12pt; font-family: Times New Roman">
                        <td style="height: 24px; width: 105px;">&nbsp;</td>
                        <td style="height: 24px">&nbsp;</td>
                        <td style="height: 24px">
                            <asp:Button ID="Button2" runat="server" class="button button1"
                                Font-Bold="True" Text="Lưu Lại" OnClick="Button2_Click" />&nbsp;
                    <asp:Button ID="Button3" runat="server" class="button button3"
                        Font-Bold="True" OnClick="btn_Cancel_Click" Text="Hủy bỏ" /></td>
                    </tr>
                </table>
            </asp:View>

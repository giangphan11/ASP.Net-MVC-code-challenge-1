...
namespace Nhom3.AdminControls
{
    public partial class index : System.Web.UI.UserControl
    {
       ...
       "alert('Bạn Không Có Quyền !');location.href='Default.aspx';", true);
            ...
            switch (Request.QueryString["page"])
            {
                ...
                case "tongquan":
                    ...
                    break;
                case "khohang":
                    PlaceHolder1.Controls.Add(LoadControl("khohang.ascx"));
                    break;
                case "baocao":
                    PlaceHolder1.Controls.Add(LoadControl("baocao.ascx"));
                    break;
            }
